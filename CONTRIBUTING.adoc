...
git clone https://github.com/hyperpolymath/social-media-tools.git cd
social-media-tools
...
toolbox create social-media-tools-dev toolbox enter
social-media-tools-dev # Install dependencies manually
...
social-media-tools/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
