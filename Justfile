...
doctor:
    @echo "Running diagnostics for social-media-tools..."
...
heal:
    @echo "Attempting auto-repair for social-media-tools..."
...
help-me:
    @echo "=== social-media-tools Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/social-media-tools/issues/new"
    @echo ""
