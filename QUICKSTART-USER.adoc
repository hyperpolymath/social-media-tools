...
// Replace social-media-tools, Social Media Tools — See README.adoc for details., just run, Social Media Tools started successfully. with actuals
= social-media-tools — Quick Start for Users
:toc:
:toclevels: 2

== What is social-media-tools?

Social Media Tools — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./social-media-tools-portable
----
...
[source]
----
Social Media Tools started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/social-media-tools/wiki
