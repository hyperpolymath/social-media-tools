...
|Frontend
|AffineScript + React 18 + TailwindCSS
...
**Data Layer:** Verisim (multi-model), XTDB (temporal), Dragonfly (cache)
...
Conversion requires migrating React/LiveView components to PanLL's panel architecture (AffineScript-native).
...
│   ├── frontend/          # AffineScript + React UI
