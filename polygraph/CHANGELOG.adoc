...
* Real fact-checking API integrations (Google Fact Check, Snopes,
PolitiFact)
...
* https://github.com/hyperpolymath/social-media-polygraph[Repository]
* https://github.com/hyperpolymath/social-media-polygraph/issues[Issue
Tracker]
